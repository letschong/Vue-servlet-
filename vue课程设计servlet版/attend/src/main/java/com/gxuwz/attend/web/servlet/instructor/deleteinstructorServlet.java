...
@WebServlet(name = "deleteinstructorServlet",urlPatterns = {"/api/deleteinstructor"})
public class deleteinstructorServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        leaveservice.deleteinstructor(insNo);
        result.setCode("200");
