...
@WebServlet(name = "daoleaveServlet",urlPatterns = {"/api/daoleave"})
public class daoleaveServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PageBean<leave> pageBean =leaveservice.getTotalRowsdaoleave(pageInfo,pageCount,stuNo);
        result.setCode("200");
