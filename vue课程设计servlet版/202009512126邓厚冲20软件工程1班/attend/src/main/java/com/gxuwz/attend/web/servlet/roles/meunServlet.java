...
import com.gxuwz.attend.entity.meuns;
...
@WebServlet(name = "meunServlet",urlPatterns = {"/api/meun"})
public class meunServlet extends BaseServlet {
    ApiResult result = new ApiResult();
    com.gxuwz.attend.service.leaveservice leaveservice = new leaveservieImp();
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        List<meuns> meuns=leaveservice.meuns();
