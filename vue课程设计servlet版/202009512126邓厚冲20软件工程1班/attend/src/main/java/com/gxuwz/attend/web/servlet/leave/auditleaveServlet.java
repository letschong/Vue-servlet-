...
@WebServlet(name = "auditleaveServlet",urlPatterns = {"/api/auditleave"})
public class auditleaveServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PageBean<leave> pageBean =leaveservice.getTotalRowsauditleave(pageInfo,pageCount,stuNo);
        result.setCode("200");
